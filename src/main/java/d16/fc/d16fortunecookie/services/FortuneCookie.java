package d16.fc.d16fortunecookie.services;
...
public class FortuneCookie {
	...
	public String getCookie() {
		...
		int randIndex = rand.nextInt(COOKIES.length);
		return COOKIES[randIndex];

		// return getCookies(1).get(0); // chuk's implementation of this method
	}

	// return num cookies
	public List<String> getCookies(int num) {
		List<String> cookies = new ArrayList<String>();
		Random rand = new Random();
		for (int i = 0; i < num; i++) {
			int randIndex = rand.nextInt(COOKIES.length);
			cookies.add(COOKIES[randIndex]);
		}
		return cookies;
	}
}
